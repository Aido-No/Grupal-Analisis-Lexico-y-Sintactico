  ...
  static final public void Input() throws ParseException {
    ...
    try {
      ...
      while (true) {
        ...
        case CHARACTER_DATA:{
          jj_consume_token(CHARACTER_DATA);
          break;
          }
        default:
          jj_la1[3] = jj_gen;
...
int localNesting = 1;
      ...
      while (true) {
        ...
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case NESTED_COMMENT_START:{
          jj_consume_token(NESTED_COMMENT_START);
localNesting++;
          break;
          }
        case COMMENT_END:{
...
if (localNesting != 0) {
            {if (true) throw new ParseException("Unclosed comment");}
        }
    } finally {
    ...
    Token closeTag = null;
      ...
      case SELF_CLOSE:{
        ...
        case CLOSE:{
          ...
          jj_consume_token(CLOSE_START);
          closeTag = jj_consume_token(NAME);
          jj_consume_token(CLOSE);
if (!openTag.image.equalsIgnoreCase(closeTag.image)) {
              {if (true) throw new ParseException("Tag mismatch: expected </" + openTag.image +
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x100,0x200,0x2c00,0x2c00,0x380000,0x380000,0x4000,0x2c00,0x2c00,0x18000,0x5c000,};
	}
